...
export default function AnthropicModelModal({ open, onClose, model }) {
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
                    <Box>
                        ...
                        <Typography variant="body1" color="text.secondary">
                            {model.description || `A ${model.type?.toLowerCase() || 'machine learning'} model by Anthropic`}
                        </Typography>
                    </Box>
