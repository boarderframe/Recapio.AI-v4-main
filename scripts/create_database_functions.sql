...
BEGIN
    INSERT INTO transcripts (tenant_id, title, content, metadata)
    VALUES (p_tenant_id, p_title, p_content, p_metadata)
...
BEGIN
    RETURN QUERY
    SELECT t.id, t.title, t.status, t.content, t.metadata, t.created_at, t.updated_at
    FROM transcripts t
